...
await writeFile(path.join(root, 'batch-manifest.json'), `${JSON.stringify({ preparedAt: new Date().toISOString(), refreshedAt: database.refreshedAt, destinationAlias: 'delta-force-official', intervalSeconds: 0, outputs }, null, 2)}\n`, 'utf8');
