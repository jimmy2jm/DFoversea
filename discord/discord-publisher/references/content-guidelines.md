...
Present the channel alias, language, thread title or ID, resolved tag IDs, attachment names, silent state, mention state, and validation warnings. Ask for explicit confirmation before invoking `--confirm-send`.
